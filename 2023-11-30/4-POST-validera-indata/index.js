...
app.post("/users", function (req, res) {
  ...
  if (isValidUserData(req.body)) {
    ...
    res.status(422).send("username should be string!"); // eller annat meddelande enligt nedan //username required!
  }
});

// funktion för att kontrollera att användardata finns
function isValidUserData(body) {
  return typeof body && body.username =="string";  // body-> Is not empty! If there is just body.username == "string" You can add userame:""
