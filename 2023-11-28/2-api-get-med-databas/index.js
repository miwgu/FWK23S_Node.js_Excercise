...
const COLUMNS = ["username", "password", "name", "email"]; // ÄNDRA TILL NAMN PÅ KOLUMNER I ER EGEN TABELL
...
//http://localhost:3000/users?username=Miwa
//http://localhost:3000/users?email=example3@hotmail.com
